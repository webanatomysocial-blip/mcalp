            ...
            <form onSubmit={handleSubmit}>
              <div className="form-row">
                ...
                <div>
                  ...
                  <input type="text" className="form-control" name="jobTitle" value={userData.jobTitle} onChange={handleChange} required />
                </div>
              </div>

              <div className="form-row-single">
                <label className="form-label">Company Name *</label>
                <input type="text" className="form-control" name="company" value={userData.company} onChange={handleChange} required />
              </div>
              ...
              <div className="form-row">
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  {emailError && <small className="form-error-text">{emailError}</small>}
                </div>
                <div>
              ...
              <button type="submit" className="btn btn-primary btn-lg w-100" disabled={isSubmitting || emailError}>
