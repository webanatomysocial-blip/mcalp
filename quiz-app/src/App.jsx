...
import ResultForm from './components/Result-Form.jsx';
...
function App() {
  ...
  const submitQuiz = async (userData) => {
    const data = { answers, user: userData };
    
    console.log('Submitting quiz with data:', data);
    
    try {
      const response = await fetch('https://mcalp.togglenow.com/api/api.php', {
        method: 'POST',
        headers: { 
    ...
    <QuizContext.Provider value={contextValue}>
      ...
      <Routes>
        <Route element={<MainLayout />}>
          ...
          <Route path="/get-report" element={<ResultForm />} />
{/* <Route path="/view-answers" element={<ViewAnswers />} /> */}
